...
Generated: `2026-08-25T20:43:50Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `441711597` / `419760235` |
| Epoch / progress | `1022` / `48.05%` |
| Recent throughput | `4.6K` TPS |
| Recent slot time | `361.45` ms |
| Active validators | `683` |
| Delinquent validators | `12` (1.73%) |
| SOL price | `$97.03` (0.46% 24h) |
| Solana TVL | `$5,631,783,978.00` |
...
| ---: | ---: | ---: | ---: |
| 60.0 s | 4.6K | 361.45 ms | 274K |
| 60.0 s | 4.5K | 365.85 ms | 267K |
| 60.0 s | 4.5K | 370.37 ms | 267K |
| 60.0 s | 4.4K | 359.28 ms | 265K |
| 60.0 s | 4.5K | 370.37 ms | 271K |

## Validator concentration

Total active stake: `433705461B` lamports. The table is ranked by activated stake; vote and node keys are identifiers, not labels for operators.
