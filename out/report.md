...
Generated: `2026-08-09T10:52:20Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `438183717` / `416237611` |
| Epoch / progress | `1014` / `31.42%` |
...
| 60.0 s | 2.7K | 437.96 ms | 162K |
| 60.0 s | 2.9K | 416.67 ms | 172K |
| 60.0 s | 2.9K | 419.58 ms | 176K |
| 60.0 s | 2.8K | 419.58 ms | 169K |
