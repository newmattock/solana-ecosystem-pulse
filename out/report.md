...
Generated: `2026-08-16T16:58:34Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `439680409` / `417730999` |
| Epoch / progress | `1017` / `77.87%` |
...
| 60.0 s | 4.1K | 410.96 ms | 243K |
| 60.0 s | 3.7K | 422.54 ms | 223K |
| 60.0 s | 3.8K | 410.96 ms | 230K |
| 60.0 s | 3.6K | 425.53 ms | 216K |
