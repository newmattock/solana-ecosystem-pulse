...
Generated: `2026-08-18T13:06:05Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `440063043` / `418113372` |
| Epoch / progress | `1018` / `66.45%` |
| Recent throughput | `4.5K` TPS |
| Recent slot time | `405.41` ms |
| Active validators | `688` |
| Delinquent validators | `7` (1.01%) |
| SOL price | `$76.13` (1.16% 24h) |
| Solana TVL | `$4,857,391,070.00` |
| DEX volume | `$1,474,970,358.36` (24h) |
| Stablecoin supply | `$15,976,698,316.16` |

## Network performance

| Sample | TPS | Slot time | Transactions |
| ---: | ---: | ---: | ---: |
| 60.0 s | 4.5K | 405.41 ms | 269K |
| 60.0 s | 4.5K | 413.79 ms | 268K |
| 60.0 s | 4.3K | 413.79 ms | 260K |
| 60.0 s | 4.5K | 408.16 ms | 271K |
| 60.0 s | 4.3K | 431.65 ms | 256K |
