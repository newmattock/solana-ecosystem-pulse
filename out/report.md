...
Generated: `2026-08-16T13:43:05Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `439652209` / `417702801` |
| Epoch / progress | `1017` / `71.34%` |
...
| 60.0 s | 3.5K | 408.16 ms | 213K |
| 60.0 s | 3.4K | 425.53 ms | 203K |
