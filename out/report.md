...
Generated: `2026-08-19T03:09:30Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `440184664` / `418234889` |
| Epoch / progress | `1018` / `94.60%` |
| Recent throughput | `3.9K` TPS |
| Recent slot time | `416.67` ms |
| Active validators | `688` |
| Delinquent validators | `7` (1.01%) |
| SOL price | `$76.72` (1.87% 24h) |
| Solana TVL | `$4,900,196,619.00` |
| DEX volume | `$1,820,756,097.04` (24h) |
| Stablecoin supply | `$16,010,511,627.13` |
