...
Generated: `2026-08-15T08:44:22Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `439401372` / `417452060` |
| Epoch / progress | `1017` / `13.28%` |
...
| ---: | ---: | ---: | ---: |
| 60.0 s | 2.6K | 413.79 ms | 154K |
| 60.0 s | 2.6K | 434.78 ms | 157K |
| 60.0 s | 3.0K | 408.16 ms | 177K |
| 60.0 s | 2.6K | 413.79 ms | 154K |
| 60.0 s | 2.7K | 410.96 ms | 165K |
