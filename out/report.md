...
Generated: `2026-08-26T01:56:35Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `441762933` / `419811474` |
| Epoch / progress | `1022` / `59.94%` |
| Recent throughput | `3.4K` TPS |
| Recent slot time | `368.10` ms |
| Active validators | `686` |
| Delinquent validators | `9` (1.29%) |
| SOL price | `$96.98` (-3.48% 24h) |
| Solana TVL | `$5,580,687,368.00` |
| DEX volume | `$2,948,794,172.19` (24h) |
| Stablecoin supply | `$16,424,674,080.87` |

## Network performance

| Sample | TPS | Slot time | Transactions |
| ---: | ---: | ---: | ---: |
| 60.0 s | 3.4K | 368.10 ms | 201K |
| 60.0 s | 3.4K | 372.67 ms | 205K |
| 60.0 s | 3.7K | 352.94 ms | 222K |
| 60.0 s | 3.9K | 365.85 ms | 235K |
| 60.0 s | 3.6K | 361.45 ms | 215K |

## Validator concentration

Total active stake: `432541767B` lamports. The table is ranked by activated stake; vote and node keys are identifiers, not labels for operators.
