...
Generated: `2026-08-15T05:37:44Z`  
...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `439374434` / `417425429` |
| Epoch / progress | `1017` / `7.04%` |
...
| ---: | ---: | ---: | ---: |
| 60.0 s | 2.7K | 419.58 ms | 160K |
| 60.0 s | 2.8K | 419.58 ms | 166K |
| 60.0 s | 2.8K | 402.68 ms | 166K |
