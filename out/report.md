...
| --- | ---: |
| RPC health | `ok` |
| Slot / block height | `441054229` / `419103535` |
| Epoch / progress | `1020` / `95.89%` |
...
| Solana TVL | `$5,502,429,032.00` |
| DEX volume | `$3,648,067,509.89` (24h) |
| Stablecoin supply | `$16,423,898,782.87` |
